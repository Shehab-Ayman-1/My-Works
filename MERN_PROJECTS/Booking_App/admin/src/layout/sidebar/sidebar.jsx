...
import { Close, Dashboard, BarChart, PeopleOutlined, Bathroom } from "@mui/icons-material";
		...
		<section className="sidebar">
			...
			<div className="body-sidebar">
				<ul className="main-list">
					...
					<li>
						<Link className="link-content" to="/hotels">
							<AddBusiness className="icon" />
							<span>Hotels</span>
						</Link>
					</li>
					<li>
						<Link className="link-content" to="/rooms">
					...
					<li>
						<Link to="/auth/login" className="link-content">
